...
export class ProjectEngine {
   ...
   */
  getTemplates(): Array<{ type: ProjectType; label: string; description: string; stepCount: number }> {
...
Description: ${description}`;
  ...
  inferProjectType(description: string): ProjectType {
    ...
    // Novel pipeline signals — full book/novel writing
    if (lower.match(/\b(novel|full book|write a book|write my book|entire book|complete novel|full manuscript|book from scratch)\b/)) {
